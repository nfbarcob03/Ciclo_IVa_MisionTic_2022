...
##### Reportes######
@app.route("/inscripciones/reporteTotalNotasPorMateriaCompleto/<string:id_estudiante>",methods=['GET'])
def getreporteTotalNotasPorMateriaCompletoByIdEstudiante(id_estudiante):
    json=miControladorInscripcion.reporteTotalNotasPorMateriaCompleto(id_estudiante)
    return jsonify(json)

@app.route("/inscripciones/reporteTotalNotasPorMateriaCompleto/",methods=['GET'])
def getreporteTotalNotasPorMateriaCompleto():
    json=miControladorInscripcion.reporteTotalNotasPorMateriaCompleto(None)
    return jsonify(json)


@app.route("/inscripciones/reporteTotalNotasPorMateriaQueryRaiz/<string:id_estudiante>",methods=['GET'])
def reporteTotalNotasPorMateriaQueryRaizByIdEstudiante(id_estudiante):
    json=miControladorInscripcion.reporteTotalNotasPorMateriaQueryRaiz(id_estudiante)
    return jsonify(json)

@app.route("/inscripciones/reporteTotalNotasPorMateriaQueryRaiz/",methods=['GET'])
def reporteTotalNotasPorMateriaQueryRaiz():
    json=miControladorInscripcion.reporteTotalNotasPorMateriaQueryRaiz(None)
    return jsonify(json)
